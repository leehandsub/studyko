...
class HomeBannerAdapter : ListAdapter<Banner, HomeBannerAdapter.HomeBannerViewHolder>(BannerDiffCallback()) {
    ...
    class HomeBannerViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val bannerImageView = view.findViewById<ImageView>(R.id.ivBannerImage)
        private val bannerBadgeTextView = view.findViewById<TextView>(R.id.tvBannerBadge)
        private val bannerTitleTextView = view.findViewById<TextView>(R.id.tvBannerTitle)
        private val bannerDetailThumbnailImageView = view.findViewById<ImageView>(R.id.ivBannerDetailThumbnail)
        private val bannerDetailBrandLabelTextView = view.findViewById<TextView>(R.id.tvBannerDetailBrandLabel)
        private val bannerDetailProductLabelTextView = view.findViewById<TextView>(R.id.tvBannerDetailProductLabel)
        private val bannerDetailDiscountRateTextView = view.findViewById<TextView>(R.id.tvBannerDetailProductDiscountRate)
        private val bannerDetailDiscountPriceTextView = view.findViewById<TextView>(R.id.tvBannerDetailProductDiscountPrice)
        private val bannerDetailPriceTextView = view.findViewById<TextView>(R.id.tvBannerDetailProductPrice)
